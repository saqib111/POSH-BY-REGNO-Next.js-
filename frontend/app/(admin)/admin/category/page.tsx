...
import CategoryTable from "@/src/features/admin/category/components/CategoryTable";
import CreateCategoryModal from "@/src/features/admin/category/modals/CreateCategoryModal";
import { useCategoriesQuery } from "@/src/features/admin/category/hooks/useCategoriesQuery";
import {
    ChevronLeft,
    ChevronRight,
    ChevronsLeft,
        ...
        <div className="space-y-10">
            ...
            <div className='px-6 md:px-10 py-8 border border-slate-200 dark:border-slate-800/60 flex flex-col md:flex-row justify-between items-center gap-6 bg-white/70 dark:bg-slate-900/20 rounded-3xl shadow-sm'>
                <span className='text-[10px] font-black uppercase tracking-[0.2em] text-slate-500 dark:text-slate-400'>
                    {Number(totalCategories).toLocaleString()} Categories Indexed
                    in Registry Stream
                </span>
