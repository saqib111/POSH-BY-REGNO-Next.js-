...
import ConfirmDeleteSubCategoryModal from "../modals/ConfirmDeleteSubCategoryModal";
    ...
    return (
        <>
            ...
            >
                ...
                <td className="px-10 py-7">
                    <span className="inline-flex items-center rounded-full border border-amber-200 bg-amber-50 px-3 py-1 text-[11px] font-black uppercase tracking-[0.14em] text-amber-700 dark:border-amber-500/20 dark:bg-amber-500/10 dark:text-amber-300">
