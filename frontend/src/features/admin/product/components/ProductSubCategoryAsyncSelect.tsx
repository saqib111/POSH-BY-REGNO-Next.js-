...
import { useInfiniteProductSubCategoryOptionsQuery } from "../hooks/useInfiniteProductSubCategoryOptionsQuery";
import type { ProductOption } from "../types";

type ProductSubCategoryAsyncSelectProps = {
    categoryId: number | null;
    value: number | null;
    selectedLabel?: string | null;
    onChange: (value: number, option?: ProductOption) => void;
    disabled?: boolean;
    error?: string;
};
...
export default function ProductSubCategoryAsyncSelect({
    categoryId,
    value,
    selectedLabel,
    onChange,
    disabled = false,
    error,
}: ProductSubCategoryAsyncSelectProps) {
    ...
    const {
        ...
        hasNextPage,
        fetchNextPage,
    } = useInfiniteProductSubCategoryOptionsQuery({
        categoryId,
        search,
        limit,
    });
    ...
    const displayLabel =
        ...
        selectedLabel ||
        (categoryMissing ? "Select category first" : "Select sub-category");
                ...
                className={`
                    ...
                    ${
                        error
                            ...
                            : "border-slate-200 focus:border-emerald-500/60 focus:ring-2 focus:ring-emerald-500/15 dark:border-white/10 dark:focus:border-emerald-500/50"
                    }
