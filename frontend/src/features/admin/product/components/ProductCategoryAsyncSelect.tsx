...
import { useInfiniteProductCategoryOptionsQuery } from "../hooks/useInfiniteProductCategoryOptionsQuery";
import type { ProductOption } from "../types";

type ProductCategoryAsyncSelectProps = {
    value: number | null;
...
export default function ProductCategoryAsyncSelect({
    value,
    selectedLabel,
    onChange,
    disabled = false,
    error,
}: ProductCategoryAsyncSelectProps) {
    ...
    const {
        ...
        hasNextPage,
        fetchNextPage,
    } = useInfiniteProductCategoryOptionsQuery({
        search,
        limit,
    });
