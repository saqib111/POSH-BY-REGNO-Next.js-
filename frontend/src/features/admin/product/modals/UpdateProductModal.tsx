...
type UpdateProductModalProps = {
    ...
    product: Product;
    onClose: () => void;
    onConfirm: (values: UpdateProductPayload) => Promise<any>;
    isLoading?: boolean;
};
...
export default function UpdateProductModal({
    ...
    const [selectedSubCategoryLabel, setSelectedSubCategoryLabel] = useState<string | null>(
    ...
    useEffect(() => {
        if (open) {
            ...
            setSelectedCategoryLabel(product.category_name);
            setSelectedSubCategoryLabel(product.sub_category_name);
        }
    }, [open, product, reset]);

    const submit = async (values: UpdateProductPayload) => {
        try {
            await onConfirm({
    ...
    return (
        <ModalShell
            ...
            subtitle="Edit product details and keep category relationships consistent."
        >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="md:col-span-2 space-y-2">
                        ...
                        <ProductCategoryAsyncSelect
                            ...
                            onChange={(val, option) => {
                                const currentCategoryId = Number(categoryValue || 0);
